...
| **3** | Scripts for generating and formatting the data are in [6_TE_processing](../6_TE_processing) | Scripts for generating dN/dS results with m0 and m1 paramaters can be found at [dnds_m0.sh](dnds_m0.sh) and [dnds_m1.sh](dnds_m1.sh) respectively |
