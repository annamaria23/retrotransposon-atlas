...
| **2** | The data used in **Figure 2** is the output of [5_TE_annotation](../5_TE_annotation) | The script for generating phylogenetic trees can be found in  [TE_groups_plot.R](TE_groups_plot.R) |
| **3** | Scripts for generating and formatting the data are in [6_TE_processing](../6_TE_processing), and _ENV_ presence or absence was obtained from [Resources/annotated_TEs.gtf](../Resources/annotated_TEs.gtf) | Scripts for generating dN/dS results with m0 and m1 paramaters can be found at [dnds_m0.sh](dnds_m0.sh) and [dnds_m1.sh](dnds_m1.sh) respectively. Results of the LRT can be found at [LRT_results.csv](./LRT_results.csv) |
