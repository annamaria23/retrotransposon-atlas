...
|**S6** | Raw sRNA-seq reads were processed as described in the methods section and the mapping percentages can be found at [piRNA_mapping_percentages.tsv](./piRNA_mapping_percentages.tsv) | NA |
