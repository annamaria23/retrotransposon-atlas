...
|**S6** | sRNA-seq files were processed as described in the methods section and the following mapping percentages can be found at [piRNA_mapping_percentages.tsv](./piRNA_mapping_percentages.tsv) | NA |
